...
import type {
  ERC721CollectionCreatedEvent,
  ERC1155CollectionCreatedEvent,
...
export async function handleERC721CollectionCreated({
  event,
  context,
}: {
  event: any;
...
export async function handleERC1155CollectionCreated({
  event,
  context,
}: {
  event: any;
